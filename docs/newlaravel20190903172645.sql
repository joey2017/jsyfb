...
INSERT INTO `admin_menu` VALUES (1,0,1,'仪表板','fa-bar-chart','/',NULL,NULL,'2019-09-01 16:53:34'),(2,0,2,'后台管理','fa-tasks',NULL,NULL,NULL,'2019-09-01 16:53:59'),(3,2,3,'Users','fa-users','auth/users',NULL,NULL,NULL),(4,2,4,'Roles','fa-user','auth/roles',NULL,NULL,NULL),(5,2,5,'Permission','fa-ban','auth/permissions',NULL,NULL,NULL),(6,2,6,'Menu','fa-bars','auth/menu',NULL,NULL,NULL),(7,2,7,'Operation log','fa-history','auth/logs',NULL,NULL,NULL),(8,0,0,'律师管理','fa-align-right','/laywers','laywer','2019-09-01 18:25:46','2019-09-01 21:16:32'),(9,0,0,'文章管理','fa-align-left','/hotacticles',NULL,'2019-09-01 18:46:17','2019-09-01 19:07:39'),(10,0,0,'资金管理','fa-rmb','/funds','balance','2019-09-01 23:23:14','2019-09-01 23:49:17'),(11,10,0,'余额管理','fa-cny','/funds/balances','balance','2019-09-01 23:30:55','2019-09-01 23:50:26'),(12,10,0,'元宝管理','fa-skype','/funds/ingots',NULL,'2019-09-02 00:24:35','2019-09-02 00:41:14'),(13,0,0,'专家管理','fa-align-center','/specialists','specialists','2019-09-02 19:12:07','2019-09-02 19:14:21'),(14,0,0,'日志查看器','fa-database','logs',NULL,'2019-09-02 19:38:08','2019-09-02 19:38:08'),(15,0,0,'用户中心','fa-user-md','/usercenter','usercenter','2019-09-02 21:24:08','2019-09-02 21:31:58'),(16,15,0,'收藏','fa-btc','/usercenter/collects','usercenter','2019-09-02 21:29:57','2019-09-02 21:31:38'),(17,15,0,'关注','fa-amazon','/usercenter/attentions','usercenter','2019-09-02 22:22:20','2019-09-02 22:22:20'),(18,15,0,'评论','fa-font','/usercenter/comments','usercenter','2019-09-02 22:41:29','2019-09-02 22:41:44'),(19,0,0,'法律宝典','fa-gavel','/legals','Legal','2019-09-02 23:20:58','2019-09-02 23:22:14'),(20,19,0,'分类','fa-sitemap','/legals/category','Legal','2019-09-02 23:27:32','2019-09-02 23:28:04'),(21,19,0,'宝典','fa-gg','/legals/books','Legal','2019-09-02 23:29:38','2019-09-02 23:29:38');
...
INSERT INTO `admin_permissions` VALUES (1,'All permission','*','','*',NULL,NULL),(2,'Dashboard','dashboard','GET','/',NULL,NULL),(3,'Login','auth.login','','/auth/login\r\n/auth/logout',NULL,NULL),(4,'User setting','auth.setting','GET,PUT','/auth/setting',NULL,NULL),(5,'Auth management','auth.management','','/auth/roles\r\n/auth/permissions\r\n/auth/menu\r\n/auth/logs',NULL,NULL),(6,'laywerManagement','laywer','','/laywers*','2019-09-01 18:26:39','2019-09-01 21:16:11'),(7,'acticleManagement','acticle','','/hotacticles*','2019-09-01 18:46:59','2019-09-01 19:08:07'),(8,'foundsManagement','founds','','/founds*','2019-09-01 23:24:07','2019-09-02 00:25:30'),(9,'specialistsManagement','specialists','','/specialists*','2019-09-02 19:13:00','2019-09-02 19:13:00'),(10,'LogsManagement','logs','','/logs*','2019-09-02 19:39:49','2019-09-02 19:39:49'),(11,'usercenterManagement','usercenter','','/usercenter/collects*\r\n/usercenter/attentions*\r\n/usercenter/comments*','2019-09-02 21:26:17','2019-09-02 22:42:52'),(12,'LegalManagement','Legal','','/legals/category/*\r\n/legals/books/*','2019-09-02 23:21:46','2019-09-02 23:25:22');
...
CREATE TABLE `jsyfb_legal_book` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='法律宝典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `jsyfb_message_content`
--

DROP TABLE IF EXISTS `jsyfb_message_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jsyfb_message_content` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jsyfb_message_content`
--

LOCK TABLES `jsyfb_message_content` WRITE;
/*!40000 ALTER TABLE `jsyfb_message_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsyfb_message_content` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `jsyfb_service_book`
--

DROP TABLE IF EXISTS `jsyfb_service_book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jsyfb_service_book` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
...
--
-- Dumping data for table `jsyfb_service_book`
--

LOCK TABLES `jsyfb_service_book` WRITE;
/*!40000 ALTER TABLE `jsyfb_service_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsyfb_service_book` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-03 17:26:50
